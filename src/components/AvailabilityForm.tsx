        ...
        <section id="checkForm" className="max-w-7xl mx-auto py-12 px-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 md:grid-cols-3 items-start justify-start gap-4">
                ...
                <div className="col-span-2 md:col-span-1">
                    ...
                    <button
                        className="w-full bg-primary-500 text-white font-semibold rounded-md opacity-100 hover:opacity-95 transition-opacity px-4 py-3"
                    >
                        Consultar Ahora
                        <svg className="inline-block ml-1" width={24} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
